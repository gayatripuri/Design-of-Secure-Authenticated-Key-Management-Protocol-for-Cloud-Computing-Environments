...
public class DataUpload extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String filekeyword = m.getParameter("filekeyword");
            ...
            System.out.println("Check------------------------------------------------------------------>>>>>");
                ...
                int i = st.executeUpdate("insert into data_files(uid, uname, enc_data, dkey, time, filekeyword, filename, data, enc_time)values('" + uid + "','" + uname + "','" + encryptedtext + "','" + Dkey + "','" + time + "','" + filekeyword+ "','" + file.getName() + "','" + sb.toString() + "','"+ encryptTime +"')");
                if (i != 0) {
                    response.sendRedirect("uploadFiles.jsp?File_uploaded");

                } else {
                    response.sendRedirect("uploadFiles.jsp?Upload_failed");
