                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <li><a class="active" href="blockedUsers.jsp">Blocked Users</a></li>
        ...
        <div class="category-post">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <br><br><br>
                        <center><h2>Blocked User</h2></center><br><br><br>
                        <div class="ex1">
                            <table id="customers">
                                <tr>
                                    <th>Name</th>
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from user_reg WHERE status = 'Blocked' ");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td><i><a class="btn btn-success btn-fill btn-circle fa fa-check" href="activateUser.jsp?id=<%=rs.getString("id")%>"> Activate</a></i></td>
                                </tr>
                                <%                                        }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
