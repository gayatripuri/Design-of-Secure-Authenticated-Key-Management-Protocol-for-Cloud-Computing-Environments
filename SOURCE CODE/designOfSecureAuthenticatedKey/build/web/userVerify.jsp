                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner-content"><br>
                            <center><h2>User Verify</h2></center><br><br>
                            <div class="row">
                                <div class="col-lg-6 align-self-center">
                                    <form id="contact" action="userVerify1.jsp" method="post" enctype="multipart/form-data">
                                        <%
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <fieldset>
                                                    <button type="submit" id="form-submit" class="main-button "><i class="fa fa-key"></i> Verify</button>
                                                    <br><br><br>
                                                </fieldset>
                                            </div>
                                        </div>
