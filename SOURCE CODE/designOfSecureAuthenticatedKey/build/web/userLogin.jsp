                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner-content"><br>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <img src="images/userlogin.jpg" width="450" height="400" />
                                </div>
                                <div class="col-lg-6 align-self-center">
                                    <form id="contact" action="userSignin.jsp" method="post">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <fieldset>
                                                    <label>Email :</label>
                                            ...
                                            <div class="col-lg-12">
                                                <fieldset>
                                                    <button type="submit" id="form-submit" class="main-button "><i class="fa fa-sign-in"></i> Login</button>&nbsp;&nbsp;&nbsp;
                                                    <a href="userSignup.jsp" class="btn btn-success btn-lg"><i class="fa fa-paper-plane"></i> Register!</a>
                                                </fieldset>
                                            </div>
                                        </div>
                                    </form>
